...
export class RateLimiter {
    ...
    refillRate;
    windowMs;
    constructor(maxRequests = 60, windowMs = 60000, keyPrefix = '') {
...
export const searchRateLimiter = new RateLimiter(parseInt(process.env['RATE_LIMIT_MAX_REQUESTS'] || '60', 10), parseInt(process.env['RATE_LIMIT_WINDOW'] || '60000', 10), 'search');
export const extractionRateLimiter = new RateLimiter(parseInt(process.env['RATE_LIMIT_MAX_REQUESTS'] || '60', 10), parseInt(process.env['RATE_LIMIT_WINDOW'] || '60000', 10), 'extraction');
